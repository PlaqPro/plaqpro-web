...
const OUVRAGES_TYPES_DATA = [
  { code:'OUV_CLOISON_BA13_M48',       corps_metier:'Plaquisterie', lot_devis:'Lot 01 - Plaquisterie', famille:'Cloisons',    designation:'Cloison BA13 sur ossature M48',        unite:'m²', temps_mo_unitaire_h:0.65, taux_horaire_ht:45, marge_materiaux:0.30, marge_mo:0.35, tva:0.10, actif:true },
  { code:'OUV_CLOISON_BA13_HYDRO_M48', corps_metier:'Plaquisterie', lot_devis:'Lot 01 - Plaquisterie', famille:'Cloisons',    designation:'Cloison BA13 hydro piece humide M48',  unite:'m²', temps_mo_unitaire_h:0.72, taux_horaire_ht:45, marge_materiaux:0.30, marge_mo:0.35, tva:0.10, actif:true },
  { code:'OUV_DOUBLAGE_LAINE_BA13',    corps_metier:'Plaquisterie', lot_devis:'Lot 01 - Plaquisterie', famille:'Doublage',    designation:'Doublage BA13 + laine minerale',        unite:'m²', temps_mo_unitaire_h:0.58, taux_horaire_ht:45, marge_materiaux:0.30, marge_mo:0.35, tva:0.10, actif:true },
  { code:'OUV_PLAFOND_BA13_SUSPENDU',  corps_metier:'Plaquisterie', lot_devis:'Lot 01 - Plaquisterie', famille:'Plafonds',    designation:'Plafond suspendu BA13',                 unite:'m²', temps_mo_unitaire_h:0.75, taux_horaire_ht:45, marge_materiaux:0.30, marge_mo:0.35, tva:0.10, actif:true },
  { code:'OUV_JOINTS_PLACO',           corps_metier:'Plaquisterie', lot_devis:'Lot 01 - Plaquisterie', famille:'Joints',      designation:'Joints plaques de platre',              unite:'m²', temps_mo_unitaire_h:0.22, taux_horaire_ht:45, marge_materiaux:0.25, marge_mo:0.35, tva:0.10, actif:true },
