...
window.CartePremium = {
  ...
  async afficherDansMonCompte(containerId) {
    ...
    container.innerHTML = '<div style="margin-bottom:20px">'
      ...
      + '<div id="carte-premium-render" style="width:420px;height:265px;background:linear-gradient(135deg,#1a1a2e 0%,#16213e 50%,#0f3460 100%);border-radius:12px;padding:16px 20px;position:relative;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,.5);font-family:system-ui,-apple-system,sans-serif;border:1px solid rgba(255,255,255,0.1);display:flex;flex-direction:column;justify-content:space-between">'
      ...
      + '</div></div>'
      + '<div style="font-size:16px;font-weight:800;color:#fff;margin-bottom:2px">Carte PlaqPro+ ' + plan + '</div>'
      + '<div style="font-size:10px;color:rgba(255,255,255,0.5);margin-bottom:10px">Avantages negocies • Tarifs partenaires • Offres fournisseurs BTP</div>'
      + '<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;margin-bottom:10px">'
      + '<div style="background:rgba(255,255,255,0.06);border-radius:8px;padding:7px"><div style="font-size:9px;color:rgba(255,255,255,0.5);letter-spacing:.1em;margin-bottom:4px">ADHERENT</div><div style="font-size:11px;font-weight:700;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">' + nom + '</div></div>'
      + '<div style="background:rgba(255,255,255,0.06);border-radius:8px;padding:7px"><div style="font-size:9px;color:rgba(255,255,255,0.5);letter-spacing:.1em;margin-bottom:4px">STATUT</div><div style="font-size:11px;font-weight:700;color:#10b981">Actif ' + annee + '</div></div>'
      + '<div style="background:rgba(255,255,255,0.06);border-radius:8px;padding:7px"><div style="font-size:9px;color:rgba(255,255,255,0.5);letter-spacing:.1em;margin-bottom:4px">ID MEMBRE</div><div style="font-size:11px;font-weight:700;color:#f59e0b">' + id + '</div></div>'
      + '</div>'
