...
var DPGF = {
  ...
  PRIX_MARCHE_DEFAUT: {
    // ── 🧱 Placo / Peinture ──
    'cloison 72':           { pu: 68,   puST: 55,   marge: 20, libelle: 'Cloison BA13 R48 72mm',                corps: 'placo' },
    'cloison 98':           { pu: 92,   puST: 74,   marge: 20, libelle: 'Cloison BA13 98/48 EI60',              corps: 'placo' },
    'cloison 100':          { pu: 88,   puST: 71,   marge: 20, libelle: 'Cloison BA13 100mm',                   corps: 'placo' },
    'doublage':             { pu: 55,   puST: 44,   marge: 20, libelle: 'Doublage BA13+isolant',                corps: 'placo' },
    'plafond ba13':         { pu: 52,   puST: 42,   marge: 20, libelle: 'Plafond BA13 suspendu',                corps: 'placo' },
    'plafond acoustique':   { pu: 92,   puST: 74,   marge: 20, libelle: 'Plafond acoustique BA13 perforé',      corps: 'placo' },
    'peinture mur':         { pu: 17,   puST: 14,   marge: 20, libelle: 'Peinture aqueuse murs Finition B',     corps: 'placo' },
    'peinture plafond':     { pu: 16,   puST: 13,   marge: 20, libelle: 'Peinture aqueuse plafond Finition B',  corps: 'placo' },
    'peinture menuiserie':  { pu: 24,   puST: 19,   marge: 20, libelle: 'Peinture menuiseries Finition B',      corps: 'placo' },
    'porte ei30':           { pu: 1200, puST: 960,  marge: 20, libelle: 'Bloc-porte EI30',                      corps: 'placo' },
    'porte ei60 simple':    { pu: 1850, puST: 1480, marge: 20, libelle: 'Bloc-porte EI60 simple DAS',           corps: 'placo' },
    'porte ei60 double':    { pu: 3200, puST: 2560, marge: 20, libelle: 'Bloc-porte EI60 double DAS',           corps: 'placo' },
    'trappe':               { pu: 105,  puST: 84,   marge: 20, libelle: 'Trappe de visite BA13 50×50',          corps: 'placo' },
    'plinthe bois':         { pu: 28,   puST: 22,   marge: 20, libelle: 'Plinthe bois dur 100×15mm',            corps: 'placo' },
    'depose plafond':       { pu: 22,   puST: 18,   marge: 20, libelle: 'Dépose adaptation repose plafond',     corps: 'placo' },
    'depose moquette':      { pu: 18,   puST: 14,   marge: 20, libelle: 'Dépose adaptation repose moquette',    corps: 'placo' },
    'nez de marche':        { pu: 16,   puST: 13,   marge: 20, libelle: 'Nez de marche aluminium',              corps: 'placo' },
    'marquage podotactile': { pu: 52,   puST: 42,   marge: 20, libelle: 'Marquage podotactile clous polyamide', corps: 'placo' },
    'main courante':        { pu: 42,   puST: 34,   marge: 20, libelle: 'Main courante acier à peindre',        corps: 'placo' },
    'lessivage':            { pu: 7.5,  puST: 6,    marge: 20, libelle: 'Lessivage préparation supports',       corps: 'placo' },
    'pictogramme':          { pu: 14,   puST: 11,   marge: 20, libelle: 'Pictogramme vinyl PMR',                corps: 'placo' },
    'peinture anti':        { pu: 15,   puST: 12,   marge: 20, libelle: 'Peinture anti-poussière',              corps: 'placo' },
    // ── ⚡ Électricité ──
    'tableau electrique':   { pu: 850,  puST: 680,  marge: 20, libelle: 'Tableau électrique équipé',            corps: 'elec' },
    'point lumineux':       { pu: 85,   puST: 68,   marge: 20, libelle: 'Point lumineux encastré',              corps: 'elec' },
    'prise courant':        { pu: 65,   puST: 52,   marge: 20, libelle: 'Prise de courant 16A',                 corps: 'elec' },
    'interrupteur':         { pu: 55,   puST: 44,   marge: 20, libelle: 'Interrupteur va-et-vient',             corps: 'elec' },
    'gaine electrique':     { pu: 12,   puST: 10,   marge: 20, libelle: 'Gaine électrique avec câble',          corps: 'elec' },
    'detection incendie':   { pu: 180,  puST: 144,  marge: 20, libelle: 'Détecteur incendie + câblage',         corps: 'elec' },
    'eclairage secours':    { pu: 220,  puST: 176,  marge: 20, libelle: 'Bloc autonome éclairage secours',      corps: 'elec' },
    'vmc':                  { pu: 650,  puST: 520,  marge: 20, libelle: 'VMC simple flux + bouches',            corps: 'elec' },
    'chauffage electrique': { pu: 320,  puST: 256,  marge: 20, libelle: 'Radiateur électrique à inertie',       corps: 'elec' },
    'climatisation':        { pu: 2800, puST: 2240, marge: 20, libelle: 'Climatiseur split mural',              corps: 'elec' },
    // ── 🚿 Plomberie / Sanitaire ──
    'wc':                   { pu: 650,  puST: 520,  marge: 20, libelle: 'WC suspendu + bâti-support',           corps: 'plomb' },
    'lavabo':               { pu: 380,  puST: 304,  marge: 20, libelle: 'Lavabo + robinetterie + siphon',       corps: 'plomb' },
    'douche':               { pu: 850,  puST: 680,  marge: 20, libelle: 'Douche à l\'italienne + paroi',        corps: 'plomb' },
    'baignoire':            { pu: 1200, puST: 960,  marge: 20, libelle: 'Baignoire + robinetterie',             corps: 'plomb' },
    'chauffe eau':          { pu: 650,  puST: 520,  marge: 20, libelle: 'Chauffe-eau électrique 150L',          corps: 'plomb' },
    'colonne plomberie':    { pu: 85,   puST: 68,   marge: 20, libelle: 'Colonne plomberie PVC/cuivre ml',      corps: 'plomb' },
    'evacuation':           { pu: 45,   puST: 36,   marge: 20, libelle: 'Évacuation PVC ml',                    corps: 'plomb' },
    'robinet arret':        { pu: 95,   puST: 76,   marge: 20, libelle: 'Robinet d\'arrêt + raccords',          corps: 'plomb' },
    // ── 🪟 Menuiserie ──
    'porte interieure':     { pu: 420,  puST: 336,  marge: 20, libelle: 'Bloc-porte intérieur 83×204',          corps: 'menu' },
    'porte entree':         { pu: 1800, puST: 1440, marge: 20, libelle: 'Porte d\'entrée blindée',              corps: 'menu' },
    'fenetre pvc':          { pu: 680,  puST: 544,  marge: 20, libelle: 'Fenêtre PVC double vitrage',           corps: 'menu' },
    'fenetre alu':          { pu: 950,  puST: 760,  marge: 20, libelle: 'Fenêtre aluminium double vitrage',     corps: 'menu' },
    'velux':                { pu: 750,  puST: 600,  marge: 20, libelle: 'Fenêtre de toit VELUX',                corps: 'menu' },
    'volet roulant':        { pu: 480,  puST: 384,  marge: 20, libelle: 'Volet roulant électrique',             corps: 'menu' },
    'placard':              { pu: 320,  puST: 256,  marge: 20, libelle: 'Placard coulissant sur mesure ml',     corps: 'menu' },
    // ── 🏠 Carrelage / Sol ──
    'carrelage sol':        { pu: 55,   puST: 44,   marge: 20, libelle: 'Carrelage sol 60×60 posé',             corps: 'carre' },
    'carrelage mur':        { pu: 65,   puST: 52,   marge: 20, libelle: 'Carrelage mural posé',                 corps: 'carre' },
    'faience':              { pu: 70,   puST: 56,   marge: 20, libelle: 'Faïence salle de bain posée',          corps: 'carre' },
    'parquet':              { pu: 48,   puST: 38,   marge: 20, libelle: 'Parquet stratifié posé',               corps: 'carre' },
    'moquette':             { pu: 28,   puST: 22,   marge: 20, libelle: 'Moquette posée',                       corps: 'carre' },
    'chape':                { pu: 22,   puST: 18,   marge: 20, libelle: 'Chape liquide autonivelante m²',       corps: 'carre' },
    'ragreage':             { pu: 12,   puST: 10,   marge: 20, libelle: 'Ragréage préparation sol m²',          corps: 'carre' },
    'plinthe carrelage':    { pu: 18,   puST: 14,   marge: 20, libelle: 'Plinthe carrelage ml',                 corps: 'carre' },
    // ── 🔧 Divers / Démolition ──
    'demolition cloison':   { pu: 35,   puST: 28,   marge: 20, libelle: 'Démolition cloison m²',               corps: 'divers' },
    'demolition carrelage': { pu: 18,   puST: 14,   marge: 20, libelle: 'Démolition carrelage m²',             corps: 'divers' },
    'evacuation gravats':   { pu: 8,    puST: 6,    marge: 20, libelle: 'Évacuation gravats m³',               corps: 'divers' },
    'bennes':               { pu: 280,  puST: 224,  marge: 20, libelle: 'Benne gravats 8m³',                   corps: 'divers' },
    'nettoyage chantier':   { pu: 5,    puST: 4,    marge: 20, libelle: 'Nettoyage chantier m²',               corps: 'divers' },
    'protection chantier':  { pu: 4,    puST: 3,    marge: 20, libelle: 'Protection sols/murs m²',             corps: 'divers' },
    'echafaudage':          { pu: 12,   puST: 10,   marge: 20, libelle: 'Échafaudage ml/semaine',              corps: 'divers' },
  },
  ...
  _buildPage() {
    return `
      <div style="max-width:1100px;margin:0 auto;padding:0 4px">
        ...
        <!-- Disclaimer IA -->
        <div style="background:rgba(245,158,11,0.08);border:0.5px solid rgba(245,158,11,0.3);border-radius:8px;padding:10px 14px;font-size:11px;color:#f59e0b;margin-bottom:16px;line-height:1.6">
⚠️ <strong>Outil d'aide à l'analyse</strong> — L'analyse IA est fournie à titre indicatif. Vérifiez toujours les exigences du CCTP avant de répondre à un appel d'offres. PlaqPro+ ne garantit pas l'exhaustivité de l'analyse.
</div>
